	...
	<div class="item-detail-info clearfix">
		...
		<div class="sc-column one-third">
			...
			<ul class="item-social-icons clearfix" n:inner-for="$i = 1; $i <= 6; $i++">
				{var $img = $options['socialImg' . $i]}
				{var $link = $options['socialLink' . $i] }
				<li class="item-social-icon left" n:if="!empty($img) && !empty($link)">
					<a href="{$link}" class="block"><img src="{$img}" alt="ico{$i}" class="block"></a>
				</li>			
			</ul>
		</div>
			...
			<div id="contact-owner-form-popup" style="display: none;">
				<div id="contact-owner-form" data-email="{$options['email']}">
					...
					<div class="input name">
						<input type="text" name="cowner-name" value="" placeholder="{_ 'Your name'}">
					</div>
					<div class="input email">
						<input type="text" name="cowner-email" value="" placeholder="{_ 'Your email'}">
					</div>
					<div class="input subject">
						<input type="text" name="cowner-subject" value="" placeholder="{_ 'Subject'}">
					</div>
					<div class="input message">
						<textarea name="cowner-message" cols="30" rows="4" placeholder="{_ 'Your message'}"></textarea>
					</div>
