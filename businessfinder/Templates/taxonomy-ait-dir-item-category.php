	...
	<div class="wrapper">
		...
		<div class="category-subcategories whiteBg clearfix">
			...
			{first}<ul class="subcategories">{/first}
				<li class="category sc-column {if $i == 4}sc-column-last {/if}one-fourth{if $i == 4}-last{/if}">
				...
				<div class="item-content-wrapper clearfix left">
					...
					<div class="item-description left">
						...
						<div class="item-meta">
							...
							{ifset $optionsDir['web']}
							<div class="item-meta-information item-address left"><a href="{$optionsDir['web']}">{$optionsDir['web']}</a></div>
							{/ifset}
